...
REM qemu-system-x86_64.exe -hda Arch-Linux-x86_64-basic-20220220.48463.qcow2 -net user,smb=src -device e1000,netdev=net0 -netdev user,id=net0,hostfwd=tcp::5555-:22 -accel hax -m 4G

qemu-system-x86_64.exe -hda Arch-Linux-x86_64-basic-20220220.48463.qcow2 -device e1000,netdev=net0 -netdev user,smb=src,id=net0,hostfwd=tcp::5555-:22 -accel hax -m 4G
